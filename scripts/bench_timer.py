...
example:
    python -m scripts.bench_timer --device auto --size 2048 --repeats 5
"""
...
def main() -> None:
    ...
    for _ in range(args.repeats):
        ...
        if device == "cuda":
            ...
            # best effort; MPS ops ofetn synchronize implicitly on tensor access
            _ = z.cpu()
